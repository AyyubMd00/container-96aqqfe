...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-96aqqfe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-96aqqfe.containers.anotherwebservice.com/
...
```
git clone git@github.com:AyyubMd00/container-96aqqfe.git
cd container-96aqqfe
```
...
```
docker attach container-96aqqfe
```
